...
| 11 | Zakres redesignu (Faza 7) | **Warianty 1c + 1f + 1h** z dokumentu designów + ikony PWA — Dziś: hero dwukolorowe z pill-row i ringiem 2:00 (1c); check emocji: lista z chipami emoji i dymkiem walidacji (1f); Progres: hero z ringiem passy, paskiem poziomu i kalendarzem ✓/🌿 (1h); nawigacja zostaje 4-elementowa (bez „+"); logika domenowa bez zmian — redesign czysto wizualny |
